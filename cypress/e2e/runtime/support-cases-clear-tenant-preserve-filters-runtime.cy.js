describe('Cycle A Support Cases clear Tenant preserving other filters runtime', () => {
  const sessionMarker = 'cycle-a-clear-tenant-session';
  const requests = [];
  const cases = [
    { id: 1401, tenant_name: 'Cycle A Supermarket', title: 'Open urgent supermarket printer hardware issue', category: 'hardware', priority: 'urgent', status: 'open', assigned_to: 'ops@example.com', created_at: '2026-09-11T03:10:00Z', updated_at: '2026-09-11T03:20:00Z' },
    { id: 1402, tenant_name: 'Cycle A Pharmacy', title: 'Open urgent pharmacy scanner hardware issue', category: 'hardware', priority: 'urgent', status: 'open', assigned_to: 'ops@example.com', created_at: '2026-09-11T03:00:00Z', updated_at: '2026-09-11T03:10:00Z' },
    { id: 1403, tenant_name: 'Cycle A Supermarket', title: 'Open medium supermarket printer hardware issue', category: 'hardware', priority: 'medium', status: 'open', assigned_to: 'ops@example.com', created_at: '2026-09-11T02:50:00Z', updated_at: '2026-09-11T03:00:00Z' },
    { id: 1404, tenant_name: 'Cycle A Supermarket', title: 'Open urgent supermarket reports issue', category: 'reports', priority: 'urgent', status: 'open', assigned_to: 'admin@example.com', created_at: '2026-09-11T02:40:00Z', updated_at: '2026-09-11T02:50:00Z' },
    { id: 1405, tenant_name: 'Cycle A Supermarket', title: 'Resolved urgent supermarket printer hardware issue', category: 'hardware', priority: 'urgent', status: 'resolved', assigned_to: 'admin@example.com', created_at: '2026-09-11T02:30:00Z', updated_at: '2026-09-11T02:40:00Z' }
  ];
  ...
  it('clears only Tenant while preserving Status, Category and Priority and restores the authoritative three-filter result set', () => {
    ...
    cy.then(() => {
      ...
      expect(requests[5].tenant).to.be.undefined;
